...
![Version: 2.2.0](https://img.shields.io/badge/Version-2.2.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 4.2.1](https://img.shields.io/badge/AppVersion-4.2.1-informational?style=flat-square)
...
| filestore.image.tag | string | `"4.2.1"` |  |
...
| imagemagick.image.tag | string | `"5.2.1"` |  |
...
| libreoffice.image.tag | string | `"5.2.1"` |  |
...
| pdfrenderer.image.tag | string | `"5.2.1"` |  |
...
| transformmisc.image.tag | string | `"5.2.1"` |  |
...
| transformrouter.image.tag | string | `"4.2.1"` |  |
