...
![Version: 2.9.0-alpha.0](https://img.shields.io/badge/Version-2.9.0--alpha.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 4.4.2](https://img.shields.io/badge/AppVersion-4.4.2-informational?style=flat-square)
...
| filestore.image.tag | string | `"4.4.2"` |  |
...
| imagemagick.image.tag | string | `"5.4.2"` |  |
...
| libreoffice.image.tag | string | `"5.4.2"` |  |
...
| pdfrenderer.image.tag | string | `"5.4.2"` |  |
...
| transformmisc.image.tag | string | `"5.4.2"` |  |
...
| transformrouter.image.tag | string | `"4.4.2"` |  |
