...
![Version: 2.7.0](https://img.shields.io/badge/Version-2.7.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 4.4.0](https://img.shields.io/badge/AppVersion-4.4.0-informational?style=flat-square)
...
| filestore.image.tag | string | `"4.4.0"` |  |
...
| imagemagick.image.tag | string | `"5.4.0"` |  |
...
| libreoffice.image.tag | string | `"5.4.0"` |  |
...
| pdfrenderer.image.tag | string | `"5.4.0"` |  |
...
| transformmisc.image.tag | string | `"5.4.0"` |  |
...
| transformrouter.image.tag | string | `"4.4.0"` |  |
