...
![Version: 8.0.0-alpha.0](https://img.shields.io/badge/Version-8.0.0--alpha.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 5.3.2](https://img.shields.io/badge/AppVersion-5.3.2-informational?style=flat-square)
...
| messageBroker.uniqueClientId | bool | `true` | When true, each pod gets a unique JMS client ID derived from the pod's UID, preventing client ID collisions in clustered deployments. |
