...
![Version: 6.3.0-alpha.0](https://img.shields.io/badge/Version-6.3.0--alpha.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 2.0.20](https://img.shields.io/badge/AppVersion-2.0.20-informational?style=flat-square)
...
|------------|------|---------|
|  | alfresco-insight-zeppelin | 4.7.0-alpha.0 |
...
| insightEngineImage.tag | string | `"2.0.20"` |  |
...
| searchServicesImage.tag | string | `"2.0.20"` |  |
