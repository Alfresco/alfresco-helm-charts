...
![Version: 5.1.0](https://img.shields.io/badge/Version-5.1.0-informational?style=flat-square) ![AppVersion: 2.0.17](https://img.shields.io/badge/AppVersion-2.0.17-informational?style=flat-square)
...
|------------|------|---------|
|  | alfresco-insight-zeppelin | 4.1.0 |
...
| insightEngineImage.tag | string | `"2.0.17"` |  |
...
| searchServicesImage.tag | string | `"2.0.17"` |  |
