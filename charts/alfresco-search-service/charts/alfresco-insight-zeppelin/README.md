...
![Version: 4.3.0](https://img.shields.io/badge/Version-4.3.0-informational?style=flat-square) ![AppVersion: 2.1.0-SNAPSHOT](https://img.shields.io/badge/AppVersion-2.1.0--SNAPSHOT-informational?style=flat-square)
...
| image.tag | string | `"2.1.0-SNAPSHOT"` |  |
