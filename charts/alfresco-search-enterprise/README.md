...
![Version: 4.6.0](https://img.shields.io/badge/Version-4.6.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 5.2.1](https://img.shields.io/badge/AppVersion-5.2.1-informational?style=flat-square)
...
| liveIndexing.content.image.tag | string | `"5.2.1"` |  |
...
| liveIndexing.mediation.image.tag | string | `"5.2.1"` |  |
...
| liveIndexing.metadata.image.tag | string | `"5.2.1"` |  |
...
| liveIndexing.path.image.tag | string | `"5.2.1"` |  |
...
| reindexing.image.tag | string | `"5.2.1"` |  |
